...
* データはLSB(一番下のビット)が先頭
* ブロックの順序は、1,2,3,4,....3,4(1と2は最初だけ、3,4はファイルの数だけ繰り返す)
* ギャップも含めた順序は以下のテーブルを参照

|内容|説明|
|:-|:-|
|先頭ｷﾞｬｯﾌﾟ|*1|
|ブロック１|ディスク情報ブロック, Disk info block|
|ﾌﾞﾛｯｸ間ｷﾞｬｯﾌﾟ|*2|
|ブロック２|ファイル数ブロック, File amount block|
|ﾌﾞﾛｯｸ間ｷﾞｬｯﾌﾟ|*2|
|ブロック３|ファイルヘッダーブロック, File header block|
|ﾌﾞﾛｯｸ間ｷﾞｬｯﾌﾟ|*2|
|ブロック４|ファイルデータブロック, File data block|
|ﾌﾞﾛｯｸ間ｷﾞｬｯﾌﾟ|*2|
|:|:|
|ﾌﾞﾛｯｸ間ｷﾞｬｯﾌﾟ|*2|
|ブロック３|ファイルヘッダーブロック, File header block|
...
* *1 先頭ギャップ = 26150ビット以上, 標準的に28300ビット
* *2 ブロック間ギャップ = 480ビット以上, 標準的に976ビット
...
|||||
||2|CRC|[別途説明](#CRC)<br>FDSフォーマットでは省略|
...
|2|2|CRC|[別途説明](#CRC)<br>FDSフォーマットでは省略|
...
|16|2|CRC|[別途説明](#CRC)<br>FDSフォーマットでは省略|
*1 CRC
